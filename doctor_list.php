...
$stmt = $conn->prepare("SELECT * FROM doctor_specialist");
...
while($row = $result->fetch_assoc()) {
    ?>
                                    <tr>
										...
										<td>
                                        <button onclick="location.href='patient_schedule.php?userid=<?php echo  $row['user_id'] ?>&name=<?php echo  $row['doctor_name'] ?>' " class="btn btn-success custom-badge status-green" value="Submit">   View Schedule  </button> 
