            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-7 col-6">
                        <h4 class="page-title">Search Appointments ?</h4>
                    </div>
                </div>
				...
				<div class="profile-tabs">
					<ul class="nav nav-tabs nav-tabs-bottom">
						<li class="nav-item"><a class="nav-link active" href="#about-cont" data-toggle="tab">Search by Date</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h3 class="card-title">Enter date with select Doctor</h3>
...
<div class="col-sm-4">
    <div class="form-group">
        <label>Start Appointment Date </label>
...
<div class="col-sm-4">
    <div class="form-group">
        <label>End Appointment Date </label>
...
while($row = mysqli_fetch_array($result3)){
    ...
    $label2 = "".$row['dates']." ";
                  ...
                  ?>
                    ...
                    <tr>
                        <td colspan="3"><strong><?php  echo $label2  ?></strong> <span class="float-right"> </td>  <td>  <?php  echo $chart_datass  ?></span></td><td>  <span >  <?php  echo $label1  ?></span></td>
                    </tr>
                <?php
}
    ...
    <div class="col-sm-6">
        <div>
            <h4 class="m-b-12"><strong>Deductions</strong></h4>
