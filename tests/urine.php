        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 class="payslip-title">Urine Testings for Mr. <?php echo $_GET['name'];  ?></h4>
                            <div class="row">
                                                                ...
                                                                <tbody id="rows">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" id="3" name="3" class="con">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" id="4" name="4" class="con">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <select class="select" id="9" name="9">
                                                                                <option value="Select">Select</option>
                                                                                <option value="Occational">Occational</option>
                                                                                <option value="Nil">Nil</option>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <select class="select" id="13" name="13">
                                                                                <option value="Select">Select</option>
                                                                                <option value="Occational">Occational
                                                                                </option>
                                                                                <option value="Nil">Nil</option>
...
?>
                            ...
                            <div class="m-t-20 text-center">
                                <input type="button" class="btn btn-primary submit-btn" name="schedule" value="Update Test"
                                    id="test">
                            </div>
                            <br>
                    ...
                    $(document).ready(function () {
                        ...
                        $(document).on('click', '#test', function () {
                            ...
                            if (valid) {
                                ...
                                $.ajax({
                                    url: "../testquery/urine.php", // Url to which the request is send
