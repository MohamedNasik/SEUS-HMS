        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 class="payslip-title">Blood Count Testings for Mr. <?php echo $_GET['name'];  ?></h4>
                            <div class="row">
                                                ...
                                                <div class="card-box">
                                                                ...
                                                                <tbody id="rows">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" id="1" class="con_password">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" id="2" class="con_password" >
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" id="3" class="con_password" >
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" id="4" class="con_password" >
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" id="5" class="con_password" >
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" id="6" class="con_password" >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" id="7" class="con_password" >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" id="8" class="con_password" >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" id="9" class="con_password">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" id="10" class="con_password" >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" id="11" class="con_password" >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" id="12" class="con_password" >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" id="13" class="con_password" >
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <p>
                                                                <strong><span id="days" class="info text-danger"></span></strong> </p>
                                                            <center>
...
?>
                            ...
                            <div class="m-t-20 text-center">
                                <input type="button" class="btn btn-primary submit-btn" name="schedule" value="Update Test" id="test">
                            </div>
                            <br>
                    ...
                    if (valid) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $('input[id=test]').prop('disabled',true);
