                                ...
                                <div class="card-box">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                                        <li class="nav-item"><a class="nav-link active"
                                                href="#solid-rounded-justified-tab1" data-toggle="tab">Medical
                                                Prescribings</a></li>
                                        ...
                                        <div class="tab-content">
                                          ...
                                          if(mysqli_num_rows($results) > 0){
                                              ...
                                              { ?>
                                                  ...
                                                  $med_records = json_decode($row['med_records'],true);
                                          
                                                  if (is_array($med_records) || is_object($med_records)) {
                                                      foreach($med_records as $key => $object) {
...
?>
                                                                ...
                                                                <tbody id="rows">
                                                                    ...
                                                                    <td width="200px" id="medicinename"> <select
                                                                            name="med_name[]" id="med_name[]"
                                                                    ...
                                                                    <td id="mor"> <input type="text" name="morning[]" id="morning[]" class="form-control morning" value="<?php echo $object['morning'] ?>" />
                                                                    </td>
                                                                    <td id="noo"> <input type="text" name="noon[]" id="noon[]" class="form-control noon" value="<?php echo $object['noon'] ?>" />
                                                                    </td>
                                                                    <td id="nigh"> <input type="text" name="night[]" id="night[]" class="form-control night" value="<?php echo $object['night'] ?>" />
                                                                    </td>
                                                                    <td id="period"> <input type="text" name="period[]" id="period[]" class="form-control period" value="<?php echo $object['period'] ?>" />
                                                                    </td>
                                                                    <td> <button type="button" name="remove" id="remove" class="btn btn-danger btn-xs remove" onClick="re();"> <i  class="fa fa-trash"></i> </button> </td>
                                                            ...
                                                            <div align="right">
                                                                <button type="button" name="add" id="add"
                                                                    class="btn btn-success btn-xs"> <i  class="fa fa-plus"></i> </button>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-md-12"><strong> Remark (Diet Advice) </strong></label> <br> <br>
                                                            <div class="col-md-10">
                                                                <textarea rows="5" cols="5" id="dietadvice" name="dietadvice" class="form-control summernote" placeholder="Enter your remark here"><?php echo  $remark    ?></textarea>
                                                                <span id="dietadvice_info" class="info text-danger"></span>
...
// edit prescription
            $(document).on('click', '#submit', function () {
                ...
                if (valid) {
                    swal({
                        ...
                        function (isConfirm) {
                            ...
                            $.ajax({
                                url: "adminquery/prescription/1/update_medicine.php", // Url to which the request is send
                ...
                function validateContact() {
                    ...
                    if (!$(".morning").val()) {
                        $("#mediciness").html("(Some field are empty in medicine table, Please fill it !!!!)");
                    ...
                    for (let i = 0; i < testIdList.length; i++) {
                        if (!testIdList.item(i).value) {
                            $("#test_id_info").html("(Remove the empty fields)");
                            $("#morning[]").css('background-color', '#FFFFDF');
                            valid = false;
                        }
                    }
