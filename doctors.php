...
<?php
        ...
        $sql='SELECT u.user_id,u.prefix,u.fname,u.lname,u.address,ds.specilization,u.image,u.email FROM users as u INNER JOIN doctor_specialist as ds ON u.user_id=ds.user_id AND u.role_id= 2 ';
        ...
        if( $res ){
            $stmt->store_result();
            $stmt->bind_result($user_id,$prefix,$fname,$lname,$address,$specilization,$image,$email);
...
?>
                            ...
                            <div class="doc-prof"> <i class="fa fa-user"> </i>   <?php    echo  $specilization  ?></div>
...
setInterval(function () {
    $('#ids').load("adminquery/fetch/fetch_doctor.php").fadeIn("slow");
}, 1000);



setInterval(function () {
    $('#users').load("adminquery/fetch/fetch_doctor.php").fadeIn("slow");
}, 1000);
