                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 col-8 text-right m-b-30">
                        <div class="btn-group btn-group-sm">
                            ...
                            <a class="btn btn-white" href="patient_test_payments.php"><i class="fa fa-back fa-lg"></i> Back to menu</a>
                        </div>
                    </div>
                </div>
...
<?php
  include ('auth/dbconnection.php');
   ...
   $stmt = $conn->prepare("SELECT * FROM test_invoices as ti INNER JOIN testings AS t ON ti.test_id=t.test_id INNER JOIN prescription as p ON p.pres_id=ti.pres_id INNER JOIN users as u ON u.user_id=ti.user_id AND ti.pres_id=? ");
                                ...
                                <div class="row">
                                    ...
                                    <?php  $pres=  $_GET['id'];    ?>
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li><strong> <span>Patient Name : </span> <a href="#"><?php  echo $_GET['pname'];   ?></a>  </strong> </li>

												<li><span>Prescription No. : </span> <a href="#"><?php  echo $_GET['id'];  ?></a></li>
...
<?php 
$result = mysqli_query($conn, "SELECT SUM(charge) AS value_sum FROM test_invoices WHERE pres_id= '$pres' "); 
