            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Add Laboratorist</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form method="POST" id="doctor_form">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="password" id="con_password"  name="con_password">
                            ...
                            <div class="m-t-20 text-center">
                                <input type="button" class="btn btn-primary submit-btn" name="Register"
                                    value="Create Laboratorist" id="Register">
                            </div>
                            <center>
    ...
    $('#dob').attr('max', maxDate);
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#Register', function () {
                ...
                //var doctor_active = $('#doctor_active').val();
                ...
                if (valid) {
                    ...
                    swal({
                        title: "Are you sure?",
                        text: "You wanna save this Laboratorist !",
                        type: "warning",
                        ...
                        function (isConfirm) {
                            ...
                            $.ajax({
                                url: "adminquery/add_laboratorist.php", // Url to which the request is send
                                ...
                                success: function (response) {
                                    ...
                                    swal("saved!", "The Laboratorist has been saved!!", "success");
                                    $('#fname').val('');
                                    $('#lname').val('');
                                    $('#email').val('');
                                    $('#password').val('');
