                    ...
                    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4>Predicted Deceases (Last 1 Year) [Category wise]</h4>
                ...
                <!-- <div class="row">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="chart-title">
                                <h4>Statistical Analysis for Deceases found (Last 30 Days)</h4>
                    ...
                    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="chart-title">
                                    <h4>Statistical Analysis for Deceases found (All)</h4>
                                    <div class="float-right">
...
<?php
      ...
      // morris js starts
            // VERTICLE cHART appointments starts
            $stmt4 = $conn->prepare("SELECT decease_name, DATE_FORMAT(date, '%M') as dates, count(*) Consultations from prescription WHERE decease_name !='Reconsultation Need' AND date BETWEEN ADDDATE(NOW(),-365) AND NOW()  group by decease_name , DATE_FORMAT(date, '%M')");
            $chart_datass = '';
...
?>
          ['<?php echo $label2; ?>','<?php echo $chart_datass; ?>',<?php echo $label1; ?>  ],
...
?>
{
  ...
  options: {
    ...
    options: {
      ...
      title: {
        display: true,
        text: 'Predicted deceases of Patients'
      }
    }
});
