            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-5 col-4">
                        <h4 class="page-title">Select Prescription  </h4>
                    </div>
...
<br><br><br><br>
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <div class="card shadow">
                            <div class="card-body text-center">
                                ...
                                <!-- <h5 class="text-xxl">7,652</h5> --> <br>
                                <a href="check_investigation.php?pres_id=<?php  echo $_GET['pres_id']; ?>&apt_id=<?php  echo $_GET['apt_id']; ?>&apt_date=<?php  echo $_GET['apt_date']; ?>" class="btn btn-primary "> <i class="fa fa-eye">  View  </i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <div class="card shadow">
                            <div class="card-body text-center">
                                <i class="fa fa-medkit fa-4x text-warning"></i>
                                <h4 class="mt-3 text-xl">Medicine Details</h4><br><br>
                                <!-- <h5 class="text-xxl">7,652</h5> -->
                                <a href="check_medical.php?pres_id=<?php  echo $_GET['pres_id']; ?>&apt_id=<?php  echo $_GET['apt_id']; ?>&apt_date=<?php  echo $_GET['apt_date']; ?>" class="btn btn-warning "> <i class="fa fa-eye">  View  </i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <div class="card shadow">
                            <div class="card-body text-center">
                                ...
                                <h4 class="mt-3 text-xl">Testing Details </h4><br><br>
                                <!-- <h5 class="text-xxl">7,652</h5> -->
                                <a href="check_test.php?pres_id=<?php  echo $_GET['pres_id']; ?>&apt_id=<?php  echo $_GET['apt_id']; ?>&apt_date=<?php  echo $_GET['apt_date']; ?>" class="btn btn-success "> <i class="fa fa-eye">  View  </i></a>
                            </div>
                        </div>
                    </div>
