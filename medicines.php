...
<head>
    ...
    <link href="assets/css/others/css.css">
        ...
        if( $_SESSION['role_id']=='1' ){
            ...
            ?>
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="add-medicines.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add
                            Medicines</a>
                    </div>
                    <?php  } ?>
        ...
        $(document).ready(function () {
            ...
            function fetch_Data() {
                ...
                var data = $('#myTable').DataTable({
                    ...
                    "serverSide": true,
                    "order": [],
                    "ajax": "adminquery/fetch/fetch_medicine.php",
                     dom: 'lBfrtip',
