            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-admin.php" class="btn btn-primary btn-rounded float-right"><i
...
$sql='SELECT u.user_id,u.prefix,u.fname,u.lname,u.address,u.image,u.email FROM users as u  WHERE u.role_id= 1 ';
...
?>
                            ...
                            <div class="doc-prof"> <i class="fa fa-user"> </i> <?php    echo  "Administrator"  ?></div>
...
//  delete admins
        $("#cancelid").click(function () {
            ...
            setInterval(function () {
                $('#ids').load("adminquery/fetch/fetch_admin.php").fadeIn("slow");
            }, 1000);



            setInterval(function () {
                $('#users').load("adminquery/fetch/fetch_admin.php").fadeIn("slow");
            }, 1000);
