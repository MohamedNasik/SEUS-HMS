            ...
            <div class="content">
             ...
             <br><br> <br><br>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                        ...
                        <a href="view_blood_count.php?p_id=<?php echo $_GET['p_id']; ?>">	<span class="dash-widget-bg2"><i class="fa fa-stethoscope" aria-hidden="true"></i></span>     </a>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                        <div class="dash-widget">
                        <a href="view_urine.php?p_id=<?php echo $_GET['p_id']; ?>">    <span class="dash-widget-bg1"><i class="fa fa-flask" aria-hidden="true"></i></span></a> 
                            <div class="dash-widget-info text-right">
                                <!-- <h3>618</h3> -->
