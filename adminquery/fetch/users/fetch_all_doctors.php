...
$column= array('u.user_id','doctor_name','specilization','address','gender','dob','contact');

// $query = "SELECT * FROM appointment as a,users as u WHERE a.user_id= u.user_id";

$query = " SELECT * FROM users as u INNER JOIN doctor_specialist as d ON u.user_id=d.user_id";
...
if(isset($_GET["search"]["value"])){
  ...
  $query .= '
  AND ( u.user_id LIKE "%'.$_GET["search"]["value"].'%"
