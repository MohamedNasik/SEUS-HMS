...
$stmt->bind_param("ssii",$p_id,$_POST["dates"], $_SESSION["user_id"], $doctor_status);
$stmt->execute();
     ...
     <thead>
        ...
        $output .='
         ...
         <tr>
            ...
            <td><a href="select_prescription.php?pres_id='.$row["pres_id"].'&apt_id='.$row["apt_id"].'&apt_date='.$row["apt_date"].' ">'.$row["pres_id"].'</a></td>
