...
$column= array('apt_id','doctor_name','u.specilization','patient_name','type','apt_date','admin_status');
...
if(isset($_GET["search"]["value"])){
  ...
  OR  u.specilization LIKE "%'.$_GET["search"]["value"].'%"
...
{
 $query .= ' AND (apt_date BETWEEN  "'.$_GET['startdate'].'" AND "'.$_GET['enddate'].'") ';
}
