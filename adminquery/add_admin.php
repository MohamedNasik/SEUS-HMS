...
exit();
  ...
  //   $pdf->Cell(150,45,'Adminstrators of the Hospital',50,1,'C');
  //   $pdf->Cell(30,10,'SEUS Hospital',10,1,'C');
  
  
  //   $pdf->Cell(25,12,'User ID',1);
  //   $pdf->Cell(25,12,'First Name',1);
  //   $pdf->Cell(25,12,'Last Name',1);
  //   $pdf->Cell(50,12,'Address',1);
  //   $pdf->Cell(20,12,'Gender',1);
  //   $pdf->Cell(25,12,'DOB',1);
  //   $pdf->Cell(20,12,'Cantact',1,true);
  
  
  //   $stmt = $conn->prepare("SELECT * FROM users WHERE role_id='1' ");
  //   $stmt->execute();
  ...
  //     $pdf->Cell(25,12,$user_id,1);
  //     $pdf->Cell(25,12,$fname,1);
  //     $pdf->Cell(25,12,$lname,1);
  //     $pdf->Cell(50,12,$address,1);
  //     $pdf->Cell(20,12,$gender,1);
  //     $pdf->Cell(25,12,$dob,1);
  //     $pdf->Cell(20,12,$contact ,1,true);
  
  //   }
  
  // }else{
  
  //     $pdf->Cell(47,12,'No Admins',1);
