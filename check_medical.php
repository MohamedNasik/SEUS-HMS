<?php
       ...
       if(!isset($_SESSION['user_id'])){
        ...
        if($type == 'Consultation'){
         header("Location:edit_prescription.php?aptid=$apt_id&pres_id=$pres_id&apt_date=$apt_date"); 

   }else{

     header("Location:edit-prescription.php?aptid=$apt_id&pres_id=$pres_id&apt_date=$apt_date"); 
