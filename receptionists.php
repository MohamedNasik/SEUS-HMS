            ...
            <div class="content" >
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Receptionist</h4>
                    </div>
...
if( $_SESSION['role_id']=='1'){
     ...
     ?>
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-receptionist.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Receptionist</a>
                    </div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<h3>Are you sure want to delete this Receptionist?</h3>
...
setInterval(function () {
    $('#ids').load("adminquery/fetch/fetch_rep.php").fadeIn("slow");
}, 1000);



setInterval(function () {
    $('#users').load("adminquery/fetch/fetch_rep.php").fadeIn("slow");
}, 1000);
