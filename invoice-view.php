                                ...
                                <div class="row">
                                    ...
                                    <?php  $pres=  $_GET['payid'];    ?>
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li><strong> <span>Patient Name : </span> <a href="#"><?php  echo $_GET['name'];   ?></a>  </strong> </li>
...
<?php 
$result = mysqli_query($conn, "SELECT SUM(charge) AS value_sum FROM test_invoices WHERE test_payment_id= '$payment_id' "); 
