...
?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <?php   $testingremark = str_replace( '&', '&amp;', $object['testingremark']); ?>
                                                        <textarea rows="5" cols="5" id="testing_remark"
                                                            name="testing_remark" class="form-control summernote"
                                                            placeholder="Enter your remark here"> <?php echo $testingremark  ?></textarea>
                ...
                if (valid) {
                    swal({
                        ...
                        function (isConfirm) {
                            ...
                            $.ajax({
                                url: "adminquery/prescription/2/update_test_prescription.php", // Url to which the request is send
