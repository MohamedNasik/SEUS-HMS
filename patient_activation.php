...
if(isset($_SESSION['p_id'])){
    header("location: insert_appointment_id.php");
        ...
        <div class="error-box">
            <form action="http://dreamguys.co.in/preclinic/template/index.html">
                <div class="lock-user">
                    ...
                    <h5> Need to edit Prescription? </h5>
                </div>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if ($.trim(response) === 'fail') {
                                ...
                                $('#warn').html('<div class="alert alert-danger alert-dismissible fade show" role="alert"> <strong>Error!</strong>     Email ID is not in your list. <a href="#" class="alert-link">  </a><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                                ...
                                $('#warn').html('<div class="alert alert-success alert-dismissible fade show" role="alert"> <strong>Success!</strong>     Email ID found. <a href="#" class="alert-link">  </a><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');

                                setTimeout(function () {
                                    //Redirect with JavaScript
                                    window.location.href = 'activation_verification.php';
                                }, 3000);
