                        ...
                        <form method="POST" id="doctor_form">
                            ...
                            <div class="m-t-20 text-center">
                                <input type="button" class="btn btn-primary submit-btn" name="Register"
                                    value="Create Receptionist" id="Register">
                            </div>
                            <center>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#Register', function () {
                ...
                if (valid) {
                    ...
                    swal({
                        title: "Are you sure?",
                        text: "You wanna save this Receptionist !",
                        type: "warning",
                        ...
                        function (isConfirm) {
                            ...
                            $.ajax({
                                url: "adminquery/add_receptionist.php", // Url to which the request is send
                                ...
                                success: function (response) {
                                    ...
                                    swal("saved!", "The Receptionist has been saved!!", "success");
                                    $('#fname').val('');
                                    $('#lname').val('');
                                    $('#email').val('');
                                    $('#password').val('');
