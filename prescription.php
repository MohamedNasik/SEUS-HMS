...
$input = base64_decode($_GET['datas']);
$jsondata1 = json_decode($input);
$aptid= $jsondata1->aptid;
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-12 text-right m-b-30">
                        <a href="doctor_recommendations.php?pname=<?php echo $pname ?>&p_id=<?php echo $p_id?> "
                            class="btn btn-success btn-rounded"><i class="fa fa-user-md"> </i> Doctor Recomedations </a>

                        <a href="patient_activations.php?p_id=<?php echo $p_id  ?>&aptid=<?php echo $aptid ?> "
                            ...
                            <a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#take"><i
                                class="fa fa-user"> </i> Prescribe Another Doctor</a>
...
$query="SELECT * FROM appointment as ap INNER JOIN users as u ON ap.user_id=u.user_id  AND No= '$no' ";
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-lg-12 m-b-20">
                                    <ul class="list-unstyled">
                                        <li>
                                            <h5 class="mb-0"><strong>Dr. <?php echo $row['fname'];  ?>   <?php echo $row['lname'];  ?>     </strong>
                                            </h5>
                                        </li>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="solid-rounded-justified-tab1">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-12"><strong> Presenting
                                                            Complaints <span class="text-danger">*</span> </strong></label> <br> <br>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-12"><strong> Past History <span class="text-danger">*</span>
                                                        </strong></label> <br> <br>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-12"><strong> Investigations <span class="text-danger">*</span>
                                                        </strong></label> <br> <br>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select" id="decease" name="decease">
                                                            ...
                                                            <option value="Reconsultation Need"> Reconsultation Need</option>
                                            ...
                                            <div class="tab-pane" id="solid-rounded-justified-tab3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input pass" type="radio" name="pass"
                                                            id="no" value="no need testings" checked>
...
<input type="hidden" name="" id="p_ids" value="<?php echo $p_id ?>">
