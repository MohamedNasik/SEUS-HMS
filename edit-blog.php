                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <div class="form-group">
                                <label>Title</label>
                                <input class="form-control" type="text" name="blog_title" id="blog_title" value="<?php echo $title ?>">
                     ...
                     <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="blog_sub_title" id="blog_sub_title" value="<?php echo $sub_title ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <option value="select">Select</option>
                                           <option value="Health Care" <?php if( $cat=="Health Care") echo 'selected="selected"'; ?>>Health Care</option>
                                            <option value="Child" <?php if( $cat=="Child") echo 'selected="selected"'; ?>>Child</option>
                                            <option value="Hospital" <?php if( $cat=="Hospital") echo 'selected="selected"'; ?>>Hospital</option>
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <textarea class="summernote hidden" id="body"
                                        placeholder="Type Your Message.."> <?php echo $body?> </textarea>
                            ...
                            <!-- <div class="form-group">
                                <label>Tags </label>
                                <input type="text" placeholder="Enter your tags" data-role="tagsinput" class="form-control" id="tags" name="tags" value="<?php echo $tags?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="blogid" value="<?php echo $_GET['blog_id'] ?>">

                                <div class="form-group">
                                <label class="display-block">Blog Status</label>
								<div class="form-check form-check-inline">
									<input class="form-check-input blog_status " type="radio" name="blog_status" id="blog_status" <?php if($row['status'] == "Active") { echo "checked"; }?>  value="Active" >
									<label class="form-check-label" for="blog_active">
									Active
									</label>
                                    </div>
								<div class="form-check form-check-inline">
									<input class="form-check-input blog_status" type="radio" name="blog_status" id="blog_status" <?php if($row['status'] == "Inactive") { echo "checked"; }?>   value="Inactive">
...
function(isConfirm){
    if (!isConfirm) return;
      ...
      size: 'viewport'
          ...
          $.ajax({
             url: "blog/blog_update.php", // Url to which the request is send
              ...
              success: function (response) {
                ...
                if ($.trim(response) === 'Records Updatetd successfully.') {
    
                swal("Success!", "You blog has been Updated.", "success");
