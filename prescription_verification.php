...
//     header("location: patient_activation.php");
        ...
        <div class="error-box">
            <form action="http://dreamguys.co.in/preclinic/template/index.html">
                <div class="lock-user">
                    ...
                    <h5> Need to edit Prescription Number <?php echo $_GET['pres_id']  ?>  ? </h5>
                </div>
...
<br>
                <div id="warn"> </div>
                <input class="form-control" type="hidden" id="pres_id" value="<?php  echo $_GET['pres_id'] ?>">
                <input class="form-control" type="hidden" id="apt_id" value="<?php  echo $_GET['apt_id'] ?>">
                <input class="form-control" type="hidden" id="apt_date" value="<?php  echo $_GET['apt_date'] ?>">
...
<input type="button" class="btn btn-primary account-btn" name="login" value="Submit" id="login">
                ...
                <div class="text-center">
                    <a href="insert_appointment_id.php">Back</a>
                </div>
            </form>
        </div>
    </div>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#login', function () {
                ...
                if (valid) {
                    ...
                    $.ajax({
                        url: "doctorquery/otp_prescription.php", // Url to which the request is send
                        ...
                        success: function (response) {
                            ...
                            if ($.trim(response) === 'Success') {
                                ...
                                setTimeout(function () {
                                    ...
                                    window.location= 'select_prescription.php?pres_id='+pres_id + '&apt_id='+apt_id+ '&apt_date=' +apt_date;
                                }, 3000);
