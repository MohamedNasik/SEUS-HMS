...
<!-- <div class="btn-group btn-group-sm">
       <a href="adminquery/add_admin.php?print=1"> <button class="btn btn-white" id="print" name="cancel"><i class="fa fa-print"></i> View</button></a>
    </div> --> </div>
...
"serverSide": true, 
"ajax": "adminquery/fetch/users/fetch_all_admins.php",
dom: 'lBfrtip',
