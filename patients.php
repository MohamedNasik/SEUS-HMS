...
"serverSide": true, 
"ajax": "adminquery/fetch/patient/fetch_all_patient.php",
dom: 'lBfrtip',
...
$("#cancelid").attr('p_id', $(this).attr('data_id'));
...
var data_id = $("#cancelid").attr('p_id');
$.ajax({
    data: { 'data_id': data_id, },
    type: "POST",
    url: "adminquery/fetch/patient/delete.php",
